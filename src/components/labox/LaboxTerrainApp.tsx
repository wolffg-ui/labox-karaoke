...
export default function App() {
      ...
      <div style={wrap as any}>
        ...
        <div style={{ ...body, paddingTop:64 } as any}>
          ...
          <div style={{ marginTop:40, paddingTop:16, borderTop:"1px solid #F0F0F0", display:"flex", flexDirection:"column", gap:8 } as any}>
            ...
            <button onClick={() => setScreen("planning")} style={{ ...btnGhost, width:"100%", textAlign:"left" } as any}>📅 Planning 4 semaines →</button>
  ...
  // SCREEN: PLANNING (4 WEEKS)
  if (screen === "planning") return (
    <div style={wrap as any}>
      <div style={hdr as any}><div><div style={logo as any}>Planning 4 semaines</div><div style={eyebrow as any}>Assignation par jour</div></div><button onClick={() => setScreen("profile")} style={{ background:"none", border:"none", fontSize:11, color:"#AAA", cursor:"pointer", fontFamily:"inherit", marginTop:4 } as any}>← retour</button></div>
